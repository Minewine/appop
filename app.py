...
def create_app(config_class=Config):
    ...
    if is_running_under_passenger():
        ...
        app.register_blueprint(auth_bp, url_prefix='/appop/auth')  # Explicit path for auth
        app.register_blueprint(contact_bp, url_prefix='/appop')  # Explicit path for contact
